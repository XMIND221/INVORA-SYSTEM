const EVENT_PLACEHOLDER =
  'linear-gradient(145deg, oklch(0.18 0 0) 0%, oklch(0.1 0 0) 50%, oklch(0.06 0 0) 100%)';
  ...
  return (
    <article className="relative p-1 rounded-[28px] bg-gradient-to-b from-white/[0.12] to-transparent">
      <div className="relative bg-surface rounded-[24px] overflow-hidden border border-white/5">
        <div className="relative w-full aspect-[4/5] overflow-hidden" style={{ background: EVENT_PLACEHOLDER }}>
          ...
          <div className="absolute bottom-0 inset-x-0 p-6">
            ...
            <h3 className="font-serif italic text-3xl leading-none text-white mb-5">{title}</h3>
            <div className="flex items-end justify-between gap-4">
              <div>
                <p className="text-[10px] uppercase tracking-widest text-white/50 mb-1">Statut</p>
